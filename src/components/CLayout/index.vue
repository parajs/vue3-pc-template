    ...
    <el-container>
      <el-aside :width="width">
          <div class="pa-3">
            ...
            <el-button type="primary" size="large" style="width: 100%">创建Lab</el-button>
          </div>
          ...
          >
            <el-sub-menu index="1">
              ...
              <el-menu-item :route="{name:'Lab',params: {id: 1}}" index="/lab/1" >Lab标题</el-menu-item>
              <el-menu-item :route="{name:'Lab',params: {id: 2}}" index="/lab/2">Lab标题</el-menu-item>
            </el-sub-menu>
            <el-sub-menu index="4">
              <template #title>
              ...
              <el-menu-item :route="{name:'Lab',params: {id: 3}}" index="/lab/3">Lab标题</el-menu-item>
              <el-menu-item :route="{name:'Lab',params: {id: 4}}" index="/lab/4">Lab标题</el-menu-item>
            </el-sub-menu>
